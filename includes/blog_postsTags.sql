...
CREATE TABLE `postsTags` (
  ...
  CONSTRAINT `tagID` FOREIGN KEY (`tagID`) REFERENCES `tags` (`tagsID`) ON DELETE CASCADE ON UPDATE CASCADE
...
-- Dump completed on 2017-06-07 13:58:22
